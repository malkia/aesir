...
enum {
	...
	PF_ExtendedSuiteTool_CAMERA_PAN,		//changed from PF_ExtendedSuiteTool_CAMERA_TRACK_XY
	PF_ExtendedSuiteTool_CAMERA_DOLLY,		//changed from PF_ExtendedSuiteTool_CAMERA_TRACK_Z
