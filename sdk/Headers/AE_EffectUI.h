...
enum {
	...
	PF_Cursor_CONTEXT, 
	PF_Cursor_SLIP_EDIT, 
	PF_Cursor_CAMERA_ORBIT, 		//changed from PF_Cursor_ORBIT
	PF_Cursor_CAMERA_PAN,			//changed from PF_Cursor_TRACK_XY
	PF_Cursor_CAMERA_DOLLY, 		//changed from PF_Cursor_TRACK_Z
	PF_Cursor_ROTATE_X, 
	PF_Cursor_ROTATE_Y, 
	PF_Cursor_ROTATE_Z, 
	PF_Cursor_ARROW_X, 
