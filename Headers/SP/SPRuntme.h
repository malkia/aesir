...
/** @ingroup Suites
	...
	\li Acquire this suite using \c #SPBasicSuite::AcquireSuite() with the constants
		\c #kSPRuntimeSuite and \c #kSPRuntimeVersion.
	*/
...
typedef struct
{
	SPAPI SPErr (*SPAcquireSuiteFunc)( SPSuiteListRef suiteList, const char *name, int apiVersion, int internalVersion, const void **suiteProcs );
	SPAPI SPErr (*SPReleaseSuiteFunc)( SPSuiteListRef suiteList, const char *name, int apiVersion, int internalVersion );
